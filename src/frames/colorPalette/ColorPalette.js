      ...
      <div className="project-content">
        <div className="text-container">
          ...
          <h3 className="main-text">
            ...
            vulputate ante, eu luctus enim luctus nec. Mauris vel ante lorem. Ut
            eu nibh sodales, blandit metus porttitor, suscipit tellus. Phasellus
            elementum ante quis metus aliquam rutrum. Fusce ornare neque felis,
            at sagittis ligula pharetra ut suscipit mattis nunc. Nunc mollis
            justo et nunc pretium viverra.
          </h3>
        </div>
      </div>
